...
public class CardsDto {
    ...
    @Schema(
            description = "Mobile number for customer account, example: 01552223737"
    )
    ...
    @Schema(
            description = "Card number for customer account, example: 545357182781"
    )
    private String cardNumber;

    @NotEmpty(message = "Card type cannot be null or empty")
    @Schema(
            description = "Card type for customer account, example: DEBIT"
    )
